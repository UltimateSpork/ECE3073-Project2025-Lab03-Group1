...
module M1_mm_interconnect_0_router_001_default_decode
  #(
...
module M1_mm_interconnect_0_router_001
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    localparam PAD4 = log2ceil(64'h4041130 - 64'h4041128); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h4041130;
    ...
    M1_mm_interconnect_0_router_001_default_decode the_default_decode(
    ...
    // ( 0x4041128 .. 0x4041130 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 27'h4041128   ) begin
